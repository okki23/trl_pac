...
$bodyparses = array("billingId" => $postBillingId, "nomorHandphone" => $postNomorHp, "channelId" => $postChannelId);

$bodyparse = json_encode($bodyparses);

// Contoh function call       

// $get_data = callPACPayment('POST', 'https://fintech-dev.pactindo.com/api/v1/issuer/inqLoanKS','M-00007286', 
//    'PAC-20Y4O8qRgPoB.', $bodyparse);
//echo $get_data;
...
$get_data = callPACPayment('POST', 'https://fintech-dev.pactindo.com:6973/api/v1/issuer/inqLoanKS',
   'M-00007286', 'PAC-20Y4O8qRgPoB.', $bodyparse);
echo $get_data;
?>
